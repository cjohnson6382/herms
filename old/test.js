...
var DbObject = require('./modules/objectHelper.js').DbObject;
...
//                        console.log('returned from API get in fillinCopy: ', file);
        ...
        app.post('/savemetadata', urlencodedParser, function (req, res) {
            ...
            //  I need to figure out what's calling this or I'll never figure out what the metadataitems are
            var fields = JSON.parse(req.body.metadataitems);

            //  presumably this is the docid of the document that's going to be 'saved' to drive as a template
            ...
            var fileMetadata = {
                name: filename,
//  this is commented out because I couldn't get the stupid appDataFolder to work
                   ...
                   service.files.update({
                       ...
                       if (err) {
                           console.log("error updating metadata", err);
                            ...
                            //  new GetAndSet('session', { id: sessionId }, updateobject); 
